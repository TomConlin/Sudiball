...
ota_id = 16;		// apx what diameter mirror
...
ball_dia = 30;		// what diameter ball to use
thickness = 0.75;	// sheet material thickness

// hole pattern parameters
// these are holes about the permiter for fixturing
hp_patdia    =	27;	// pattern diameter (apx; ball_dia - 4 * thickness)
